...
def forgot_password():
    if request.method == 'POST':
        ...
        if user:
            ...
            msg = Message('Reset Your Password — E-Gov Portal', recipients=[email])
            msg.body = f"""Hi {user.username},

You requested a password reset for your E-Government Portal account.
...
"""
            try:
                ...
                flash('Could not send email. Please check your email address or contact support.', 'error')
        else:
